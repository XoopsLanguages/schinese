...
//2.7.1 backfilled translations
define('_AM_SYSTEM_MAINTENANCE_CHOICE3', '修复表');
define('_AM_SYSTEM_MAINTENANCE_CHOICE2', '检查表');
define('_AM_SYSTEM_MAINTENANCE_CHOICE4', '分析表');
define('_AM_SYSTEM_MAINTENANCE_DUMP_RECORDS', '条记录');
define('_AM_SYSTEM_MAINTENANCE_CHOICE1', '优化表');
